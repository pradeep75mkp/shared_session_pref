...
import 'package:plugin_platform_interface/plugin_platform_interface.dart';
import 'package:shared_session_pref/shared_session_pref_web.dart';
...
/// [SharedSessionPrefPlatform] methods.
abstract class SharedSessionPrefPlatform extends PlatformInterface {
  /// Constructs a SharedPreferencesStorePlatform.
  SharedSessionPrefPlatform() : super(token: _token);

  static final Object _token = Object();

  /// The default instance of [SharedSessionPrefPlatform] to use.
  ///
  /// Defaults to [MethodChannelSharedPreferencesStore].
  static SharedSessionPrefPlatform get instance => _instance;

  /// Platform-specific plugins should set this with their own platform-specific
  /// class that extends [SharedSessionPrefPlatform] when they register themselves.
  static set instance(SharedSessionPrefPlatform instance) {
    if (!instance.isMock) {
  ...
  static SharedSessionPrefPlatform _instance =
  SharedSessionPrefWeb();
...
class InMemorySharedPreferencesStore extends SharedSessionPrefPlatform {
